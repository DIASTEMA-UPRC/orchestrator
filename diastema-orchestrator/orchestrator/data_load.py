...
def data_load(playbook, job, last_bucket):
    ...
    front_obj.diastema_call(message = "update", update = "Loaded Dataset for the analysis with ID: "+playbook["analysis-id"])
